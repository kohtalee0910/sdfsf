...
public class GrabEntityAbilityInstance extends AbstractAbilityInstance {
    ...
    public float absorbTransition = 0.0f;
    public float absorbTransitionO = 0.0f;
    ...
    public float getAbsorbTransitionProgress(float partialTicks) {
        return Mth.lerp(partialTicks, absorbTransitionO, absorbTransition) / 3.0f;
    }
    ...
    public void tickIdle() { // Called every tick of LatexVariantInstance, for variants that have this ability
        ...
        this.absorbTransitionO = this.absorbTransition;
        ...
        if (this.grabbedEntity != null) {
            ...
            if (attackDown && useDown && suited) {
                this.absorbTransition += 0.075f;
            }

            if (this.absorbTransition > 0.0f) {
                this.absorbTransition = Math.max(0.0f, this.absorbTransition - 0.025f);
                if (this.absorbTransition > 3.0f && suited) {
                    if (ProcessTransfur.tryAbsorption(this.grabbedEntity, this.entity, 4.0f, null)) {
                        this.absorbTransition = 0f;
                        this.releaseEntity();
                        return;
                    }
                }
    ...
    public void saveData(CompoundTag tag) {
        ...
        tag.putFloat("AbsorbTransition", absorbTransition);
    }
    ...
    public void readData(CompoundTag tag) {
        ...
        if (this.grabbedEntity != null) {
            ...
            this.absorbTransition = tag.getFloat("AbsorbTransition");
        }
    }
}